<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="军衔" prop="junxian">
          <el-input v-model="ruleForm.junxian" 
              placeholder="军衔" clearable  :readonly="ro.junxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="军衔" prop="junxian">
              <el-input v-model="ruleForm.junxian" 
                placeholder="军衔" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="办公地点" prop="bangongdidian">
          <el-input v-model="ruleForm.bangongdidian" 
              placeholder="办公地点" clearable  :readonly="ro.bangongdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="办公地点" prop="bangongdidian">
              <el-input v-model="ruleForm.bangongdidian" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='junxian'){
            this.ruleForm.junxian = obj[o];
	    this.ro.junxian = true;
            continue;
          }
          if(o=='zhicheng'){
	    ...
	    this.ro.zhicheng = true;
          ...
          if(o=='bangongdidian'){
            this.ruleForm.bangongdidian = obj[o];
	    this.ro.bangongdidian = true;
            continue;
          }
        }
      }
