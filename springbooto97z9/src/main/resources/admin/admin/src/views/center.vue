  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'"  label="类型" prop="leixing">
          <el-select v-model="ruleForm.leixing" placeholder="请选择类型">
            <el-option
                v-for="(item,index) in yonghuleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="学院" prop="xueyuan">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="军衔" prop="junxian">
          <el-input v-model="ruleForm.junxian"               placeholder="军衔" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="办公地点" prop="bangongdidian">
          <el-input v-model="ruleForm.bangongdidian"               placeholder="办公地点" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  mounted() {
    ...
    this.yonghuleixingOptions = "学院,教员,校长,主任".split(',')
